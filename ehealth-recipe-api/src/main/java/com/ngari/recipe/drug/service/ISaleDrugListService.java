...
public interface ISaleDrugListService {
    ...
    @RpcService
    QueryResult<DrugListAndSaleDrugListDTO> querySaleDrugListByOrganIdAndKeyword(Date startTime, Date endTime, Integer enterpriseId, String drugClass, String keyword, Integer status, Integer type,String producer, int start, int limit);
