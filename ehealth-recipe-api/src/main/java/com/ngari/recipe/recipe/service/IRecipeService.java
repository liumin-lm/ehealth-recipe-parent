...
public interface IRecipeService extends IBaseService<RecipeBean> {
    ...
    QueryResult<Map> findRecipesByInfo(Integer organId, Integer status,
                                       ...
                                       Integer depart, int start, int limit, List<Integer> organIds, Integer giveMode,Integer fromflag,Integer recipeId,Integer enterpriseId,Integer checkStatus,Integer payFlag);
