...
* @Date: 2019/7/25
*/
public class HdPosition implements Serializable {
    ...
    public HdPosition(String longitude, String latitude) {
    ...
    public static boolean checkParameter (HdPosition position) {
