        ...
        if(null != enterprise){
            if (CollectionUtils.isNotEmpty(orgDrugList)) {
                ...
                for (OrganDrugList organDrug : orgDrugList) {
                    ...
                    dto.setHospDrugId(String.valueOf(organDrug.getDrugId()));
                ...
                try {
                    ...
                    LOGGER.info("ByRemoteService.corresPondingHospDrugByOrganIdHttpRequest:[{}][{}]同步药品请求，请求内容：{}", enterprise.getId(), enterprise.getName(), requestStr);
