...
public abstract class AbstractGiveModeService implements IGiveModeBase{
    ...
    public void setOtherButton(GiveModeShowButtonVO giveModeShowButtonVO, Recipe recipe){
        ...
        LOGGER.info("AbstractGiveModeService.setOtherButton recipeId:{}, recordType:{},recordStatusCode:{},showUseDrugConfig:{}.", recipe.getRecipeId(), recordType, recordStatusCode, showUseDrugConfig);
        //已完成的处方单设置
