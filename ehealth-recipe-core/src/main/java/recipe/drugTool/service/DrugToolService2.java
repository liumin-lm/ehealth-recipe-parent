...
//public class DrugToolService2 implements IDrugToolService {
//
//    /**
//     * 修改匹配中的原状态（已提交，已匹配）
//     */
...
//    private static final Logger LOGGER = LoggerFactory.getLogger(DrugToolService2.class);
...
//    @Override
//    @LogRecord
//    public Map<String, Object> readDrugExcel(byte[] bufParam, String originalFilename, int organId, String operator) {
//        Map<String, Object> result = Maps.newHashMap();
//        LOGGER.info(operator + "开始 readDrugExcel 方法" + System.currentTimeMillis() + "当前进程=" + Thread.currentThread().getName());
//        //保存到ossid
//        String fileId = fileUploadService.uploadFileWithoutUrt(bufParam, originalFilename);
...
//            drug=obtainReadExcelDrugListMatch(cells,bankNumber,rowIndex,result);
//            rowIndex++;
//            total++;
//        });
