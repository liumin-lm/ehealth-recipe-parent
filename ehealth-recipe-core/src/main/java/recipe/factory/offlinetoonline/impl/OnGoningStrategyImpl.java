...
public class OnGoningStrategyImpl extends BaseOfflineToOnlineService implements IOfflineToOnlineStrategy {
    ...
    public FindHisRecipeDetailResVO findHisRecipeDetail(FindHisRecipeDetailReqVO request) {
        ...
        HisResponseTO<List<QueryHisRecipResTO>> hisRecipeInfos = hisRecipeManager.queryData(request.getOrganId(), patientDTO, 6, OfflineToOnlineEnum.OFFLINE_TO_ONLINE_ONGOING.getType(), request.getRecipeCode(),null,null);
