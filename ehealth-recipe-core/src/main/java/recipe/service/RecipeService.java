...
//    }
    ...
    @RpcService
    public Object packageCAFromRecipe(Integer recipeId, Integer doctorId, Boolean isDoctor){
        ...
        try {
            ...
            if(null == requestSealTO){
                LOGGER.warn("当前CA组装pdf信息返回空，中断当前CA");
                return null;
            }
    ...
    public Object packageCAFromBus(Integer recipeId){
