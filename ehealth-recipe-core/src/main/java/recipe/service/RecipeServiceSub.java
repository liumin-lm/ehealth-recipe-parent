...
//                        }
    ...
    public static Map<String, Object> getRecipeAndDetailByIdImpl(int recipeId, boolean isDoctor, Integer depId) {
            ...
            if (null != recipe.getRecipeCode()) {
                ...
                if(recipeOrders != null){
                    if(recipeOrders.getGiveModeKey().equals(GiveModeTextEnum.SUPPORTTOHIS.getGiveModeTextV1())){
                        ...
                        if(!flag){
                            cancelFlag = cancelFlag && !(new Integer(1).equals(recipeOrders.getPayFlag()) && recipeOrders.getActualPrice() > 0);
                        }
                    }
                }
            }
        ...
        boolean showChecker = recipeAuditClient.isShowChecker(recipe, null);
...
//                }
    ...
    public static Map<String, Object> cancelRecipeImpl(Integer recipeId, Integer flag, String name, String message) {
        ...
        if (order != null) {
            ...
            orderService.cancelOrderWithRecipeId(order, OrderStatusConstant.CANCEL_MANUAL, recipeId);
