...
public class RecipeServiceSub {
    ...
    public static Integer saveRecipeDataImpl(RecipeBean recipeBean, List<RecipeDetailBean> detailBeanList, Integer flag) {
        ...
        //电子病历，将电子病历保存到cdr模块
        doWithSavaOrUpdateEmr(recipe, recipeBean.getRecipeExtend());
     ...
     * @param recipeExt
     */
    private static void doWithSavaOrUpdateEmr(Recipe recipe,RecipeExtendBean recipeExt){
        try{
...
//            }
    ...
    public static String getUnSendTitleForPatient(Recipe recipe) {
        ...
        switch (recipe.getStatus()) {
            ...
            case RecipeStatusConstant.CHECK_PASS_YS:
            case RecipeStatusConstant.READY_CHECK_YS:
                if (!RecipeBussConstant.PAYMODE_TFDS.equals(recipe.getPayMode()) && !RecipeBussConstant.PAYMODE_COD.equals(recipe.getPayMode())) {
