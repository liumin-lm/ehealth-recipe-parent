...
public enum TabStatusEnumNew {
     ...
     */
    Ongoing_Recipe_StatusList("ongoing", "recipe", Arrays.asList( 3, 4, 5, 40,7)),
    /**
     * 已结束订单的状态(已完成)
     * date 2019/10/16
     ...
     * 已下载(待取药)的处方归并到已完成里
     */
    Isover_Recipe_StatusList("isover", "recipe", Arrays.asList(14, 17, 13, 15, 12, 6, 9,20, 23, 18, 41, 42, 43));
