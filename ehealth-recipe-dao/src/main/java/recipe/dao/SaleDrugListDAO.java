...
public abstract class SaleDrugListDAO extends HibernateSupportDelegateDAO<SaleDrugList>
    ...
    public abstract SaleDrugList findByOrganIdAndDrugId(@DAOParam("organId") int organId, @DAOParam("drugId") Integer drugId);
     ...
     * @return         药品列表
     */
    @DAOMethod(sql = "from SaleDrugList where organId=:organId ")
