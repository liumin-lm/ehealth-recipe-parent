 ...
 */
@Schema
public class RecipeRollingInfo implements Serializable {
    ...
    public RecipeRollingInfo() {
    }

    public RecipeRollingInfo(Integer clinicOrgan, Integer depart, Integer doctor, String mpiId) {
