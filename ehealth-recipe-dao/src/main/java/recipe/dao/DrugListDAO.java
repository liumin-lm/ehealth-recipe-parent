...
public abstract class DrugListDAO extends HibernateSupportDelegateDAO<DrugList>
    ...
    public abstract List<DrugList> findRepeatDrugList(@DAOParam("drugName") String drugName,@DAOParam("saleName") String saleName,@DAOParam("drugType") Integer drugType, @DAOParam("producer") String producer, @DAOParam("drugSpec") String drugSpec  );
